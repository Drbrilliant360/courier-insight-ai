...
-- Create zones table for delivery zones (using text for now, can be upgraded to proper geometry later)
CREATE TABLE public.zones (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  name TEXT NOT NULL UNIQUE,
  boundary_coordinates TEXT, -- Store as JSON string of coordinates
...
CREATE POLICY "Couriers can update own profile" ON public.couriers FOR UPDATE TO authenticated USING (true);
...
-- Insert sample zones
INSERT INTO public.zones (name, boundary_coordinates, delivery_fee, avg_delivery_time) VALUES
('Manhattan', '[[-74.0479,40.6829],[-73.9067,40.6829],[-73.9067,40.8176],[-74.0479,40.8176],[-74.0479,40.6829]]', 5.00, 22),
('Brooklyn', '[[-74.0421,40.5707],[-73.8331,40.5707],[-73.8331,40.7395],[-74.0421,40.7395],[-74.0421,40.5707]]', 4.50, 26),
('Queens', '[[-73.9623,40.5411],[-73.7004,40.5411],[-73.7004,40.8007],[-73.9623,40.8007],[-73.9623,40.5411]]', 4.00, 28);
